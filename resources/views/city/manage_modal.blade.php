<div class="modal fade" id="manageCityModal" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form action="{{route('city.manage_process')}}" method="post">
                <div class="modal-body text-sm">
                    @csrf
                    <div class="form-group">
                        <label for="name_inp">City Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="name_inp" placeholder="Enter name" name="city_name" required>
                    </div>
                </div>
