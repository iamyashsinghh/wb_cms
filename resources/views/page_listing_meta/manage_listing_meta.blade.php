    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card text-sm">
                ...
                <form action="{{route('page_listing_meta.listing_meta.manage_process', $meta->id)}}" method="post">
                    <div class="modal-body text-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>For Venue/Vendor <span class="text-danger">*</span></label>
                                    <select class="form-control" name="type" required>
                                        <option value="" disabled selected>Select Venue/Vendor</option>
                                        <option value="venue" {{$meta->type == 'venue' ? 'selected' : ''}}>Venue</option>
                                        <option value="vendor" {{$meta->type == 'vendor' ? 'selected' : ''}}>Vendor</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="modal-footer text-sm">
                        <a href="{{route('page_listing_meta.listing_meta.ajax_list')}}" class="btn btn-sm bg-secondary m-1">Back</a>
