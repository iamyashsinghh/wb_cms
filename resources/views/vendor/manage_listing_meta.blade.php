                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Enter meta description" name="meta_description" id="meta_description_count"
    ...
    <script>
        ...
        // --- CAPTURE ORIGINAL FORM DATA ---
            ...
            function triggerDraftSave() {
                ...
                $.ajax({
                    url: "{{ route('vendor.listing_meta.saveDraft', $meta->id) }}",
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
