            ...
            <div class="container-fluid">
                ...
                @canany(['create venue_vendor_list', 'super power'])
                    <div class="button-group my-4">
                        <a href="{{ route('venue.listing_meta.manage') }}" class="btn btn-sm text-light buttons-print"
            ...
            <script>
                ...
                function update_status(elem) {
                    if (confirm("Are you sure want to update the status")) {
                        ...
                        fetch(`{{ route('venue.listing_meta.update_status') }}/${data_id}/${data_status}`).then(response =>
                ...
                function update_faq(faq_id) {
                    fetch(`{{ route('venue.listing_meta.fetch_faq') }}/${faq_id}`).then(response => response.json()).then(data => {
                        ...
                        updateFaqModal.querySelector('form').action =
                            `{{ route('venue.listing_meta.update_faq') }}/${faq_id}`;
