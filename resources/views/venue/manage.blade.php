                        ...
                        <div class="row">
                            <div class="col-sm-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="venue_category[]" required multiple>
                                        ...
                                        <option value="{{ $list->id }}" {{ array_search($list->id,
                                            $venue_category_id_arr) !== false ? 'selected' : '' }}>
                                            {{ $list->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="city" onchange="get_locations(this.value);"
                                        ...
                                        <option value="{{ $list->id }}" {{ $venue->city_id == $list->id ? 'selected' :
                                            '' }}>
                                            {{ $list->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="location" id="location_select" required>
                                        ...
                                        <option value="{{ $list->id }}" {{ $venue->location_id == $list->id ? 'selected'
                                            : '' }}>
                                            {{ $list->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="related_locations[]"
                                        ...
                                        @foreach ($locations as $list)
                                        <option value="{{ $list->id }}" {{ array_search($list->id,
                                            $related_location_ids) !== false ? 'selected' : '' }}>
                                            {{ $list->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" placeholder="Enter address"
                                        name="address" required>{{ $venue->venue_address }}</textarea>
                                    @error('address')
                                    <span class="ml-1 text-sm text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter value"
                                                name="veg_foods[{{ $meal['name'] }}]" value="{{ $meal['package'] }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter value"
                                                name="nonveg_foods[{{ $meal['name'] }}]" value="{{ $meal['package'] }}"
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="budget" required>
                                        ...
                                        <option value="{{ $list->id }}" {{ $venue->budget_id == $list->id ? 'selected' :
                                            '' }}>
                                            {{ $list->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-8 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="similar_venue_select"
                                        ...
                                        <option value="{{ $list->id }}" {{ array_search($list->id,
                                            $similar_venue_id_arr) !== false ? 'selected' : '' }}>
                                            {{ $list->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" placeholder="Enter meta title"
                                        id="meta_title_count" name="meta_title">{{ $venue->meta_title }}</textarea>
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" placeholder="Enter meta keywords"
                                        name="meta_keywords">{{ $venue->meta_keywords }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control summernote" placeholder="Enter summary"
                                        name="summary">{{ $venue->summary }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 mb-3">
                                <div class="row">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="" placeholder="Enter map iframe"
                                        name="location_map" rows="5">{{ $venue->location_map }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="" placeholder="Enter "
                                                name="area_capacity_floating[]" value="{{ $list->floating }}">
                                        </div>
                                    </div>
                                    <div class="col mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="area_capacity_type[]">
                                                <option value="Indoor" {{ $list->type == 'Indoor' ? 'selected' : ''
                                                    }}>Indoor</option>
                                                <option value="Outdoor" {{ $list->type == 'Outdoor' ? 'selected' : ''
                                                    }}>Outdoor
                                                </option>
                                                <option value="Indoor+Outdoor" {{ $list->type == 'Indoor+Outdoor' ?
                                                    'selected' : '' }}>
                                                    Indoor+Outdoor</option>
                                                <option value="Poolside" {{ $list->type == 'Poolside' ? 'selected' : ''
                                                    }}>Poolside
                                                </option>
                                            </select>
                                        </div>
