<div class="modal fade" id="manageMealModal" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('meal.manage_process')}}" method="post">
                <div class="modal-body text-sm">
                    ...
                    <div class="form-group">
                        <label for="name_inp">Meal Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="name_inp" placeholder="Enter meal name" name="meal_name" required>
                    </div>
                </div>
