                ...
                <table style="margin-top: -40px;">
                    <tr>
                        <td class="template-content" style=" padding: 0rem 8% 1rem 5%;">
                            <h3 class="gap">{{$user->name}}</h3>
                            <h3 class="gap">Welcome to Wedding Banquets</h3>
                            <h3 class="gap">Here is your One Time Password to access CMS.</h3>
                            <h2 class="gap">USE CODE <span class="otp" style="color: #870808;">{{$otp}}</span></h2>
